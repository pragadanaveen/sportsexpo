  ...
  const players = [
    {
      ...
      latitude: 28.6139,
      longitude: 77.209,
      image: require("../assets/Coache1.png"),
    },
    {
      name: "Pavan",
      rating: 4.2,
            ...
            <View style={styles.modalContainer}>
              ...
              <View style={styles.modalContent}>
                ...
                <View style={styles.profileInfoRow}>
                  ...
                  {/* Rating with Background and Border Radius */}
                  <View style={styles.ratingContainer}>
                    <Text style={[styles.rating, styles.starSymbol]}>
                ...
                <View style={styles.statsRow}>
                  <Text style={styles.statsLabel}>Teams Mentored:</Text>
                  <Text style={styles.statsValue}>{selectedPlayer.teamMentored}</Text>
                </View>

                {/* Experience */}
                <View style={styles.statsRow}>
                  <Text style={styles.statsLabel}>Total Years of Experience:</Text>
                  <Text style={styles.statsValue}>{selectedPlayer.experience} years</Text>
                </View>

                {/* Buttons Row */}
                <View style={styles.buttonsRow}>
                  <TouchableOpacity
                    style={[styles.button, styles.viewProfileButton]} // Apply specific style for View Profile button
                    onPress={handleViewProfile}
                  >
                    <Text style={styles.buttonText}>View Profile</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[styles.button, styles.sendRequestButton]} // Apply specific style for Send Request button
                  >
...
const styles = StyleSheet.create({
  ...
  marker: {
    ...
    borderRadius: 10,
    // alignItems: "center",
    justifyContent: "center", // Center content within the marker
    width: 100, // Increased width of the marker
    height: 100, 
  },
  markerImage: { width: 40, height: 40, borderRadius: 25 , marginLeft: -10},
  markerRating: { fontSize: 12, marginTop: 40,  color: "#fff",marginBottom: 10, },
  searchContainer: {
    position: "absolute",
    top: 50,
    left: 20,
  ...
  viewProfileButton: {
    ...
    borderWidth: 1,
    borderColor: '#008C4C', // Green border color
  },
  sendRequestButton: {
    backgroundColor: '#008C4C', // Green background
  },
